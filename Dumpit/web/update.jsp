...
if(rs.next()){
 ...
 %>
<form  action="update.jsp?email=<%=rs.getString("e_mail")%>" method="post" >
...
<td colspan="2" align="center"><input type="submit" name="save_vendor" value="Save"/>
...
if(request.getParameter("edit")!=null){
    try{
           Class.forName("com.mysql.jdbc.Driver");
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/dumpit","root","");
        PreparedStatement ps=con.prepareStatement("select * from  user_detail where e_mail='"+id+"'");
        ResultSet rs=ps.executeQuery();
...
<%
    if(request.getParameter("save")!=null){
       ...
       String name=request.getParameter("name");
        ...
        Class.forName("com.mysql.jdbc.Driver");
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/dumpit","root","");
        PreparedStatement ps=con.prepareStatement("update user_detail set name = '"+name+"' ,phone='"+mobile+"',address='"+address+"',dob='"+dob+"',city='"+selectedcity+"' where e_mail = '"+id+"' ");
        int i=ps.executeUpdate();
            ...
            if(session.getAttribute("admin")!=null){
                 ...
                 response.sendRedirect("output.jsp?user_details");
             }}
        }catch(Exception ex){
        ...
        out.print(ex);
         ...
         if(request.getParameter("save_vendor")!=null){
