<%-- 
    Document   : index
    Created on : Sep 17, 2019, 9:16:56 AM
    Author     : Mr. Robot
--%>
...
<Center><h2><b>Services</b></h2>
    <img src="./images/scrap_collector.jpg" height="420" width="600" ><br><a href="request.jsp" ><b>Scrap pickup</b></a>
...
function onClick(element) {
  ...
  captionText.innerjsp = element.alt;
}
